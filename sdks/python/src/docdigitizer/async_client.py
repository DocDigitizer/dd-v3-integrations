"""Asynchronous DocDigitizer client."""
...
class AsyncDocDigitizer:
    ...
    async def health_check(self) -> str:
        ...
        """
        status, body, _ = await self._transport.request("GET", "/")
        if status >= 400:
    ...
    async def __aenter__(self) -> "AsyncDocDigitizer":
        return self
